...
class ArgConfig(object):
    def __init__(self):
        ...
        model_g.add_arg("config_path", str, './work/similarity_net/config/bow_pairwise.json', "Path to the json file for EmoTect model config.")
        model_g.add_arg("init_checkpoint", str, 'work/similarity_net/model_files/simnet_bow_pairwise_pretrained_model', "Init checkpoint to resume training from.")
        model_g.add_arg("output_dir", str, './work/similarity_net/model_files', "Directory path to save checkpoints")
        model_g.add_arg("task_mode", str, 'pairwise', "task mode: pairwise or pointwise")
        ...
        log_g.add_arg("test_result_path", str, "./work/similarity_net/test_result", "Directory path to test result.")
        log_g.add_arg("infer_result_path", str, "./work/similarity_net/infer_result", "Directory path to infer result.")

        data_g = ArgumentGroup(parser, "data", "Data paths, vocab paths and data processing options")
        data_g.add_arg("train_data_dir", str, './data/data12739/train_pairwise', "Directory path to training data.")
        data_g.add_arg("valid_data_dir", str, './data/data12739/dev', "Directory path to valid data.")
        data_g.add_arg("test_data_dir", str, './data/data12739/test', "Directory path to testing data.")
        data_g.add_arg("infer_data_dir", str, './data/data12739/infer', "Directory path to infer data.")
        data_g.add_arg("vocab_path", str, './data/data12739/term2id.dict', "Vocabulary path.")
        data_g.add_arg("batch_size", int, 128, "Total examples' number in batch for training.")

        run_type_g = ArgumentGroup(parser, "run_type", "running type options.")
        run_type_g.add_arg("use_cuda", bool, True, "If set, use GPU for training.")
        run_type_g.add_arg("task_name", str, 'simnet', "The name of task to perform sentiment classification.")
        ...
        run_type_g.add_arg("compute_accuracy", bool, True, "Whether to compute accuracy.")
        run_type_g.add_arg("lamda", float, 0.958, "When task_mode is pairwise, lamda is the threshold for calculating the accuracy.")
